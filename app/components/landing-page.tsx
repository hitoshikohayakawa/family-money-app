  ...
  return (
    <article className="rounded-[30px] border border-[rgba(55,140,65,0.12)] bg-white p-6 shadow-[0_20px_50px_rgba(75,175,87,0.10)]">
      <div className="flex h-20 w-20 items-center justify-center rounded-[24px] bg-[#F7FBF7] shadow-inner shadow-[rgba(75,175,87,0.08)]">
        <Image src={imageSrc} alt={imageAlt} width={64} height={64} className="h-16 w-16 object-contain" />
      </div>
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#F4FAF5_0%,#FFFFFF_16%,#FFFFFF_100%)] text-[#1F2D20]">
      ...
      <main>
        ...
        <MarketingSection className="bg-[#F7FBF7]">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            <StepCard step="01" title="親がお小遣いを登録する" description="渡す金額や日にちを決めて、子どもに渡すお小遣いをアプリに登録します。" />
            <StepCard step="02" title="子どもが受け取り方を選ぶ" description="子どもは「すぐにもらう」か「投資する」かを自分で選びながら体験できます。" />
            <StepCard step="03" title="結果を見て親子で話す" description="増えた・減った結果を見ながら、使い方や貯め方、これからの目標を話せます。" />
          </div>
        </MarketingSection>
            ...
            <div>
              ...
              <ul className="mt-6 grid gap-3">
                {[
                  ...
                  >
                    <span className="mt-1 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#E8F5E9] text-xs font-black text-[#378C41]">✓</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="rounded-[40px] bg-[linear-gradient(135deg,#4BAF57_0%,#378C41_100%)] px-6 py-10 text-white shadow-[0_28px_70px_rgba(55,140,65,0.24)] sm:px-10 sm:py-12 lg:px-14">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                <MarketingButton href="/register" variant="secondary" className="border-white/30 bg-white text-[#378C41] hover:bg-[#F4FAF5]">
                  無料ではじめる
                </MarketingButton>
                <MarketingButton href="/login" variant="ghost" className="border-white/55 text-white hover:bg-white/10">
                  ログイン
                </MarketingButton>
              </div>
            </div>
