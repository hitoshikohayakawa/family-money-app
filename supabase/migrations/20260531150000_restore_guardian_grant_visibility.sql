-- Restore full family grant visibility for guardian role.
-- Migration 20260531110000 restricted guardian to only see grants they created,
-- which broke the parent's view when another guardian (guardian_admin) had created grants.
-- Both guardian and guardian_admin should see all grants in their family.
-- Cashout payment attribution is handled separately via granted_by_user_id on cashout_requests.
