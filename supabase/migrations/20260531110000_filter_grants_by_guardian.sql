-- guardian role can now only see grants they created.
-- guardian_admin continues to see all grants in the family.
...
begin
  ...
  where ag.family_id = current_family_id
    and (
      current_role = 'guardian_admin'
      or (current_role = 'guardian' and ag.granted_by_user_id = current_user_id)
