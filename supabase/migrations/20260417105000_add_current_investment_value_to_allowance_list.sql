...
comment on function public.list_allowance_grants_for_current_user() is
  'Lists allowance grants visible to the current user, including fixed investment details and current value calculated from the latest available daily price.';
